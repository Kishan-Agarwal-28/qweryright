...
export const sqlSuggestions: SQLSuggestion[] = [
  // ===== SELECT QUERIES =====
  {
    label: 'SELECT',
    kind: 14, // Keyword
  ...
  },
  {
    ...
    insertTextRules: 4,
    documentation: 'Select all rows from left table and matching rows from right table',
  ...
  },
  {
    ...
    insertTextRules: 4,
    documentation: 'Select all rows from right table and matching rows from left table',
  ...
  },
  {
    ...
    insertTextRules: 4,
    documentation: 'Select all rows from both tables with matches where available',
  ...
  },
  {
    ...
    insertTextRules: 4,
    documentation: 'Combine results from multiple SELECT statements (removes duplicates)',
  ...
  },
  {
    ...
    insertText: 'SELECT ${1:column}\nFROM ${2:table1}\nUNION ALL\nSELECT ${1:column}\nFROM ${3:table2}',
    insertTextRules: 4,
    documentation: 'Combine results from multiple SELECT statements (keeps duplicates)',
  ...
  },
  {
    ...
    kind: 15,
    insertText: 'INSERT OR REPLACE INTO ${1:table} (${2:columns})\nVALUES (${3:values})',
    insertTextRules: 4,
  ...
  },
  {
    ...
    kind: 15,
    insertText: 'INSERT OR IGNORE INTO ${1:table} (${2:columns})\nVALUES (${3:values})',
    insertTextRules: 4,
  ...
  },
  {
    ...
    kind: 15,
    insertText: 'DELETE FROM ${1:table_a}\nWHERE ${2:id} IN (\n  SELECT ${3:id}\n  FROM ${4:table_b}\n  WHERE ${5:condition}\n)',
    insertTextRules: 4,
  ...
  },
  {
    ...
    kind: 15,
    insertText: 'CREATE TEMPORARY TABLE ${1:temp_table} (\n  ${2:column} ${3:TEXT}\n)',
    insertTextRules: 4,
  ...
  },
  {
    ...
    kind: 15,
    insertText: 'CREATE UNIQUE INDEX ${1:index_name}\nON ${2:table_name} (${3:column})',
    insertTextRules: 4,
  ...
  },
  {
    ...
    kind: 15,
    insertText: 'SUM(${1:column}) OVER (ORDER BY ${2:date} ROWS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW)',
    insertTextRules: 4,
  ...
  },
  {
    ...
    kind: 15,
    insertText: 'AVG(${1:column}) OVER (ORDER BY ${2:date} ROWS BETWEEN ${3:2} PRECEDING AND CURRENT ROW)',
    insertTextRules: 4,
  ...
  },
  {
    ...
    kind: 15,
    insertText: 'SELECT ${1:column1}, ${2:column2}, COUNT(*) as duplicate_count\nFROM ${3:table}\nGROUP BY ${1:column1}, ${2:column2}\nHAVING COUNT(*) > 1',
    insertTextRules: 4,
  ...
  },
  {
    ...
    kind: 15,
    insertText: 'WITH RECURSIVE numbers(n) AS (\n  SELECT ${1:1}\n  UNION ALL\n  SELECT n + 1\n  FROM numbers\n  WHERE n < ${2:100}\n)\nSELECT n FROM numbers',
    insertTextRules: 4,
  ...
  },
  {
    ...
    kind: 15,
    insertText: 'INSERT INTO ${1:table} (${2:id}, ${3:name})\nSELECT n, \'Item \' || n\nFROM (\n  WITH RECURSIVE numbers(n) AS (\n    SELECT 1\n    UNION ALL\n    SELECT n + 1 FROM numbers WHERE n < ${4:100}\n  )\n  SELECT n FROM numbers\n)',
    insertTextRules: 4,
  ...
  // ===== JSON OPERATIONS (SQLite 3.38+) =====
  {
    ...
    kind: 15,
    insertText: 'SELECT json_extract(${1:json_column}, \'$.${2:field}\')\nFROM ${3:table}',
    insertTextRules: 4,
  ...
  },
  {
    ...
    kind: 15,
    insertText: 'SELECT json_extract(${1:json_column}, \'$.${2:array}[${3:0}]\')\nFROM ${4:table}',
    insertTextRules: 4,
  ...
  },
  {
    ...
    kind: 15,
    insertText: 'INSERT INTO ${1:table} (${2:json_column})\nVALUES (json_object(\n  \'${3:key1}\', ${4:value1},\n  \'${5:key2}\', ${6:value2},\n  \'${7:key3}\', ${8:value3}\n))',
    insertTextRules: 4,
  ...
  // ===== FULL-TEXT SEARCH (FTS5) =====
  {
    ...
    kind: 15,
    insertText: 'CREATE VIRTUAL TABLE ${1:fts_table} USING fts5(\n  ${2:title},\n  ${3:content},\n  ${4:author},\n  tokenize = \'${5:porter ascii}\'\n)',
    insertTextRules: 4,
  ...
  },
  {
    ...
    kind: 15,
    insertText: 'SELECT highlight(${1:fts_table}, ${2:0}, \'${3:<b>}\', \'${4:</b>}\') as highlighted\nFROM ${1:fts_table}\nWHERE ${1:fts_table} MATCH \'${5:search term}\'',
    insertTextRules: 4,
  ...
  },
  {
    ...
    kind: 15,
    insertText: 'SELECT snippet(${1:fts_table}, ${2:0}, \'${3:<b>}\', \'${4:</b>}\', \'${5:...}\', ${6:20}) as snippet\nFROM ${1:fts_table}\nWHERE ${1:fts_table} MATCH \'${7:search term}\'',
    insertTextRules: 4,
  ...
  },
  {
    ...
    kind: 15,
    insertText: 'SELECT name, tbl_name\nFROM sqlite_master\nWHERE type = \'index\'\nORDER BY name',
    insertTextRules: 4,
  ...
  },
  {
    ...
    kind: 15,
    insertText: 'SELECT name, tbl_name, sql\nFROM sqlite_master\nWHERE type = \'trigger\'\nORDER BY name',
    insertTextRules: 4,
  ...
  },
  {
    ...
    kind: 15,
    insertText: 'SELECT REPLACE(${1:column}, \' \', \'\') as no_spaces\nFROM ${2:table}',
    insertTextRules: 4,
  ...
  },
  {
    ...
    kind: 15,
    insertText: 'SELECT DATE(${1:date}, \'start of month\') as first_day\nFROM ${2:table}',
    insertTextRules: 4,
  ...
  },
  {
    ...
    kind: 15,
    insertText: 'SELECT DATE(${1:date}, \'start of month\', \'+1 month\', \'-1 day\') as last_day\nFROM ${2:table}',
    insertTextRules: 4,
  ...
  },
  {
    ...
    insertTextRules: 4,
    documentation: 'Calculate Pearson correlation coefficient between two variables',
  ...
  // ===== GRAPH & HIERARCHY =====
  {
    ...
    kind: 15,
    insertText: 'WITH RECURSIVE descendants(id, name, parent_id, depth) AS (\n  SELECT id, name, parent_id, 0\n  FROM ${1:table}\n  WHERE id = ${2:root_id}\n  \n  UNION ALL\n  \n  SELECT t.id, t.name, t.parent_id, d.depth + 1\n  FROM ${1:table} t\n  JOIN descendants d ON t.parent_id = d.id\n)\nSELECT * FROM descendants',
    insertTextRules: 4,
  ...
  },
  {
    ...
    kind: 15,
    insertText: 'WITH RECURSIVE test_data(id, name, value, created_at) AS (\n  SELECT\n    1,\n    \'User_\' || 1,\n    ABS(RANDOM() % 1000),\n    DATETIME(\'now\', \'-\' || (ABS(RANDOM() % 365)) || \' days\')\n  \n  UNION ALL\n  \n  SELECT\n    id + 1,\n    \'User_\' || (id + 1),\n    ABS(RANDOM() % 1000),\n    DATETIME(\'now\', \'-\' || (ABS(RANDOM() % 365)) || \' days\')\n  FROM test_data\n  WHERE id < ${1:1000}\n)\nSELECT * FROM test_data',
    insertTextRules: 4,

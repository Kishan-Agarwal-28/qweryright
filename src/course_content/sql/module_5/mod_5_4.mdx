...
In business analytics, looking at isolated numbers often isn't enough. Knowing we sold $500 today is good. Knowing that our *cumulative* sales for the month just crossed $10,000 is better. Knowing that our *3-day moving average* is trending up is even better.
...
### Scenario 3: Running Total *Per Customer*
We can combine this with `PARTITION BY`. We want to see a running total of spend for *each* customer, ordered by their order dates.

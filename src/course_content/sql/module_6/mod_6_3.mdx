...
We want to ensure that no two users can sign up with the same email address. A Unique Index enforces this *and* speeds up lookups.
...
We often search for books by *Author* AND *Genre* together.

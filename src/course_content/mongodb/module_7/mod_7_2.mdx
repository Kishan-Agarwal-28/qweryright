...
## Summary
Real-time dashboarding is about decoupling the *ingestion* of data from the *presentation* of data. By using Change Streams for immediate counters or scheduled `$merge` aggregations for complex metrics, you can provide a responsive user experience while keeping your database load predictable.

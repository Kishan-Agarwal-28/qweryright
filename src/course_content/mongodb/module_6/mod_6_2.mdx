...
```json
[
  { "_id": 1, "title": "MongoDB Basics", "author": "Smith", "year": 2022, "tags": ["db", "programming"] },
  { "_id": 2, "title": "JS Guide", "author": "Doe", "year": 2021, "tags": ["web", "programming"] },
  { "_id": 3, "title": "Python Intro", "author": "Smith", "year": 2022, "tags": ["programming"] },
  { "_id": 4, "title": "Cooking 101", "author": "Chef", "year": 2020, "tags": ["cooking"] }
]
```
...
## Summary
By combining `$match` with `$facet`, you can build a robust search backend that provides users with both the data they asked for and the context they need to refine their search further—all in a single database operation.

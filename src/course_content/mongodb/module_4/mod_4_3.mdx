...
Array operators provide powerful tools for manipulating and analyzing arrays *within* a single document, without the need to `$unwind` them. These operators allow you to transform, filter, count, and aggregate array elements in place, maintaining the document structure while deriving new insights.

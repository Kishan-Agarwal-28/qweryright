...
import { courseStructure, type LessonItem } from '@/lib/course-structure'
...
function CourseStructurePage() {
  ...
  const courseTitle = validCourse === 'sql' ? 'SQL Foundations' : 'MongoDB Aggregations';
      ...
      >
        ...
        <div className="flex-1 p-5 md:p-6 flex flex-col justify-between min-h-40">
          <div>
            ...
            <p className="text-sm text-muted-foreground line-clamp-2 mb-4 leading-relaxed">
              In-depth guide covering {lesson.title.toLowerCase()}. Master the core concepts and implementation details for efficient data handling.
            </p>
          </div>
        ...
        <div className="w-full md:w-80 h-48 md:h-auto relative bg-muted shrink-0 overflow-hidden flex items-center justify-center">
          <Image 
            ...
            alt={lesson.title}
            layout="fullWidth" 
            className="w-full h-full object-contain transition-transform duration-700 group-hover:scale-105 opacity-90 group-hover:opacity-100 mix-blend-overlay dark:mix-blend-normal"
            loading="lazy"
            cdn='cloudinary'

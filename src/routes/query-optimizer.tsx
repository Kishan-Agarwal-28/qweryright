...
import { 
  Play, Copy, RefreshCw, Sparkles, Check, Terminal, Eraser 
} from 'lucide-react';
        ...
        <CardHeader className="pb-3 border-b bg-muted/20">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Tabs value={language} onValueChange={(v) => setLanguage(v as any)} className="w-[180px]">
        ...
        <CardHeader className="pb-3 border-b border-white/10 bg-[#252526]">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <CardTitle className="text-sm font-medium text-gray-200">Result</CardTitle>
              {output && (
                <Badge variant="secondary" className="bg-green-500/10 text-green-400 border-green-500/20 px-2 py-0 text-[10px] h-5">
                  Optimized
                </Badge>
              )}
            </div>

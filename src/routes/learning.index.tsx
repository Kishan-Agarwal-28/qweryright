...
import { Database, FileJson, Clock, BookOpen, ArrowRight } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen w-full bg-background flex items-center justify-center p-6">
      ...
      >
        ...
        {/* ================= SQL CARD ================= */}
        <Link to="/learning/$course" params={{
          course:"sql"
            ...
            >
              ...
              <div className="z-10 relative p-8 flex flex-col gap-4">
                ...
                <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-300 text-sm font-medium leading-relaxed max-w-[90%]">
                        Master structured query language. Design schemas and optimize database performance.
                    </p>
                </div>
              </div>
              ...
              <div className="z-10 relative p-8 mt-auto">
                <div className="flex items-center justify-between">
                     ...
                     {/* Interactive Pill */}
                     <motion.div 
                        className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-full shadow-lg shadow-blue-500/20 transition-colors"
                        whileHover={{ x: 5 }}
                     >
            ...
            >
              ...
              <div className="z-10 relative p-8 flex flex-col gap-4">
                ...
                <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-300 text-sm font-medium leading-relaxed max-w-[90%]">
                        Unlock the power of data pipelines. Filter, group, and transform complex documents.
                    </p>
                </div>
              </div>
              ...
              <div className="z-10 relative p-8 mt-auto">
                <div className="flex items-center justify-between">
                     ...
                     <motion.div 
                        className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-5 py-2.5 rounded-full shadow-lg shadow-green-500/20 transition-colors"
                        whileHover={{ x: 5 }}
                     >
                        <span className="text-sm font-bold">Start Learning</span>
                        <ArrowRight size={14} />

...
import type { TComment } from '@/pages/text-editor/components/ui/comment'

import { BlockDiscussion } from '@/pages/text-editor/components/ui/block-discussion'
...
const discussionsData: Array<TDiscussion> = [
  {
    id: 'discussion1',
    comments: [
      {

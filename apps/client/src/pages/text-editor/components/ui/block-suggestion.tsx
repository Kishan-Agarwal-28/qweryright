...
import type { TDiscussion } from '@/pages/text-editor/components/editor/plugins/discussion-kit'
import { Avatar, AvatarFallback, AvatarImage } from '@/components/ui/avatar'
import { Button } from '@/components/ui/button'
import { discussionPlugin } from '@/pages/text-editor/components/editor/plugins/discussion-kit'
import { suggestionPlugin } from '@/pages/text-editor/components/editor/plugins/suggestion-kit'
...
export const useResolveSuggestion = (
  ...
  const resolvedSuggestion: Array<ResolvedSuggestion> = React.useMemo(() => {
    const map = getOption('uniquePathMap')
    ...
    const res: Array<ResolvedSuggestion> = []

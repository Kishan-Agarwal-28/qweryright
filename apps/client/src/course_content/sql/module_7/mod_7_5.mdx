...
- **Analysis:** This complex pattern checks for standard email format. `!~*` returns rows that _fail_ this check.
...
Write a query to find all usernames that contain _at least one_ number.

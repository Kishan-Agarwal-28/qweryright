...
The `CREATE TABLE` statement defines a new table, its columns, and the data types for those columns. It also defines **Constraints**—rules that the data must follow.

...
In a busy **Online Bookstore**, hundreds of customers are buying books at the same second. What happens if two people try to buy the _last copy_ of "1984" at the exact same moment? Or what happens if the server crashes right after we charge a credit card but _before_ we create the order record?
